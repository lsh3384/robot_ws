...
#include "msg_srv_action_interface_py_test/srv/detail/conversion__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_srv_action_interface_py_test::srv::Conversion_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_srv_action_interface_py_test::srv::Conversion_Request & ros_message)
{
  // Member: cm
  cdr >> ros_message.cm;
...
{
  auto typed_message =
    static_cast<const msg_srv_action_interface_py_test::srv::Conversion_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_srv_action_interface_py_test::srv::Conversion_Request *>(
    untyped_ros_message);
...
static message_type_support_callbacks_t _Conversion_Request__callbacks = {
  "msg_srv_action_interface_py_test::srv",
  "Conversion_Request",
...
{
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_py_test, srv, Conversion_Request)() {
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_msg_srv_action_interface_py_test
cdr_serialize(
  const msg_srv_action_interface_py_test::srv::Conversion_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: inch
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_srv_action_interface_py_test::srv::Conversion_Response & ros_message)
{
  // Member: inch
  cdr >> ros_message.inch;
...
{
  auto typed_message =
    static_cast<const msg_srv_action_interface_py_test::srv::Conversion_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<msg_srv_action_interface_py_test::srv::Conversion_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_py_test, srv, Conversion_Response)() {
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Response__handle;
}
...
{
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_py_test, srv, Conversion)() {
  return &msg_srv_action_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion__handle;
}
