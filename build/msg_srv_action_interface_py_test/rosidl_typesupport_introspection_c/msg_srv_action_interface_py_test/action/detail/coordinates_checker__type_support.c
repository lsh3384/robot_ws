...
#include <stddef.h>
#include "msg_srv_action_interface_py_test/action/detail/coordinates_checker__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_Goal__init(message_memory);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_Result__init(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_Result__rosidl_typesupport_introspection_c__CoordinatesChecker_Result_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_Result, all_position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_Feedback__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_Feedback__rosidl_typesupport_introspection_c__CoordinatesChecker_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_Feedback, position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_Feedback__rosidl_typesupport_introspection_c__CoordinatesChecker_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_Feedback)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Request__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_SendGoal_Request__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_SendGoal_Request__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Response__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_SendGoal_Response__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_SendGoal_Response__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_members = {
  "msg_srv_action_interface_py_test__action",  // service namespace
  "CoordinatesChecker_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_type_support_handle = {
  0,
  &msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_SendGoal)() {
  if (!msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_type_support_handle.typesupport_identifier) {
    msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_SendGoal_Response)()->data;
  }

  return &msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Request__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_GetResult_Request__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_GetResult_Request__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Response__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_GetResult_Response__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_GetResult_Response__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_members = {
  "msg_srv_action_interface_py_test__action",  // service namespace
  "CoordinatesChecker_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_type_support_handle = {
  0,
  &msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_GetResult)() {
  if (!msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_type_support_handle.typesupport_identifier) {
    msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_GetResult_Response)()->data;
  }

  return &msg_srv_action_interface_py_test__action__detail__coordinates_checker__rosidl_typesupport_introspection_c__CoordinatesChecker_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_py_test__action__CoordinatesChecker_FeedbackMessage__init(message_memory);
}
...
{
  msg_srv_action_interface_py_test__action__CoordinatesChecker_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoordinatesChecker_FeedbackMessage__rosidl_typesupport_introspection_c__CoordinatesChecker_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_py_test__action__CoordinatesChecker_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoordinatesChecker_FeedbackMessage__rosidl_typesupport_introspection_c__CoordinatesChecker_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(msg_srv_action_interface_py_test__action__CoordinatesChecker_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_py_test, action, CoordinatesChecker_FeedbackMessage)() {
