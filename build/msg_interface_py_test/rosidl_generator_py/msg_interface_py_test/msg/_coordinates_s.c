...
bool msg_interface_py_test__msg__coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interface_py_test.msg._coordinates.Coordinates", full_classname_dest, 50) == 0);
  }
  msg_interface_py_test__msg__Coordinates * ros_message = _ros_message;
  {  // stamp
...
PyObject * msg_interface_py_test__msg__coordinates__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interface_py_test.msg._coordinates");
