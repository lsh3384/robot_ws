...
{
  new (message_memory) msg_interface_py_test::msg::Coordinates(_init);
}

void Coordinates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_interface_py_test::msg::Coordinates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coordinates_message_member_array[3] = {
  {
    ...
    offsetof(msg_interface_py_test::msg::Coordinates, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interface_py_test::msg::Coordinates, coordinate_x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interface_py_test::msg::Coordinates, coordinate_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coordinates_message_members = {
  "msg_interface_py_test::msg",  // message namespace
  "Coordinates",  // message name
  3,  // number of fields
  sizeof(msg_interface_py_test::msg::Coordinates),
...
get_message_type_support_handle<msg_interface_py_test::msg::Coordinates>()
{
  return &::msg_interface_py_test::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interface_py_test, msg, Coordinates)() {
  return &::msg_interface_py_test::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
