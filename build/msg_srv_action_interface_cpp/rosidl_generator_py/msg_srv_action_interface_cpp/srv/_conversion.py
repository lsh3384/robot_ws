...
class Metaclass_Conversion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'msg_srv_action_interface_cpp.srv.Conversion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from msg_srv_action_interface_cpp.srv import _conversion
...
class Conversion(metaclass=Metaclass_Conversion):
    from msg_srv_action_interface_cpp.srv._conversion import Conversion_Request as Request
    from msg_srv_action_interface_cpp.srv._conversion import Conversion_Response as Response
