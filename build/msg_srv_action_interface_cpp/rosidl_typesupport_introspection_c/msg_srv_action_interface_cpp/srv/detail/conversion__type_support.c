...
#include <stddef.h>
#include "msg_srv_action_interface_cpp/srv/detail/conversion__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  msg_srv_action_interface_cpp__srv__Conversion_Request__init(message_memory);
}

void Conversion_Request__rosidl_typesupport_introspection_c__Conversion_Request_fini_function(void * message_memory)
{
  msg_srv_action_interface_cpp__srv__Conversion_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Conversion_Request__rosidl_typesupport_introspection_c__Conversion_Request_message_member_array[1] = {
  {
    ...
    offsetof(msg_srv_action_interface_cpp__srv__Conversion_Request, cm),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Conversion_Request__rosidl_typesupport_introspection_c__Conversion_Request_message_members = {
  "msg_srv_action_interface_cpp__srv",  // message namespace
  "Conversion_Request",  // message name
  1,  // number of fields
  sizeof(msg_srv_action_interface_cpp__srv__Conversion_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_cpp, srv, Conversion_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  msg_srv_action_interface_cpp__srv__Conversion_Response__init(message_memory);
}

void Conversion_Response__rosidl_typesupport_introspection_c__Conversion_Response_fini_function(void * message_memory)
{
  msg_srv_action_interface_cpp__srv__Conversion_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Conversion_Response__rosidl_typesupport_introspection_c__Conversion_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_action_interface_cpp__srv__Conversion_Response, inch),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Conversion_Response__rosidl_typesupport_introspection_c__Conversion_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(msg_srv_action_interface_cpp__srv__Conversion_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_msg_srv_action_interface_cpp
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_cpp, srv, Conversion_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_members = {
  "msg_srv_action_interface_cpp__srv",  // service namespace
  "Conversion",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_Request_message_type_support_handle,
  NULL  // response message
  // msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_Response_message_type_support_handle
};

static rosidl_service_type_support_t msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_type_support_handle = {
  0,
  &msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_cpp, srv, Conversion)() {
  if (!msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_type_support_handle.typesupport_identifier) {
    msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_cpp, srv, Conversion_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_action_interface_cpp, srv, Conversion_Response)()->data;
  }

  return &msg_srv_action_interface_cpp__srv__detail__conversion__rosidl_typesupport_introspection_c__Conversion_service_type_support_handle;
}
