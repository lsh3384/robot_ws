...
#include "msg_srv_interface_py_test/srv/detail/conversion__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const msg_srv_interface_py_test::srv::Conversion_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_srv_interface_py_test::srv::Conversion_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_msg_srv_interface_py_test
const rosidl_message_type_support_t *
get_message_type_support_handle<msg_srv_interface_py_test::srv::Conversion_Request>()
{
  return &msg_srv_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const msg_srv_interface_py_test::srv::Conversion_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<msg_srv_interface_py_test::srv::Conversion_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &msg_srv_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion_Response__handle;
}
...
{
  return &msg_srv_interface_py_test::srv::typesupport_fastrtps_cpp::_Conversion__handle;
}
