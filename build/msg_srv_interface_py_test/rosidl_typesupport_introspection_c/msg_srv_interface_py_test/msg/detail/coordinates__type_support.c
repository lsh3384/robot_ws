...
#include <stddef.h>
#include "msg_srv_interface_py_test/msg/detail/coordinates__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  msg_srv_interface_py_test__msg__Coordinates__init(message_memory);
}

void Coordinates__rosidl_typesupport_introspection_c__Coordinates_fini_function(void * message_memory)
{
  msg_srv_interface_py_test__msg__Coordinates__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Coordinates__rosidl_typesupport_introspection_c__Coordinates_message_member_array[3] = {
  {
    ...
    offsetof(msg_srv_interface_py_test__msg__Coordinates, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_interface_py_test__msg__Coordinates, coordinate_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_srv_interface_py_test__msg__Coordinates, coordinate_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Coordinates__rosidl_typesupport_introspection_c__Coordinates_message_members = {
  "msg_srv_interface_py_test__msg",  // message namespace
  "Coordinates",  // message name
  3,  // number of fields
  sizeof(msg_srv_interface_py_test__msg__Coordinates),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_interface_py_test, msg, Coordinates)() {
