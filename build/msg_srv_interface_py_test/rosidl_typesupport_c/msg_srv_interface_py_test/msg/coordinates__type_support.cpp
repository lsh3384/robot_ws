...
#include "msg_srv_interface_py_test/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Coordinates_type_support_symbol_names_t _Coordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_srv_interface_py_test, msg, Coordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_srv_interface_py_test, msg, Coordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_msg_srv_interface_py_test
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_srv_interface_py_test, msg, Coordinates)() {
  return &::msg_srv_interface_py_test::msg::rosidl_typesupport_c::Coordinates_message_type_support_handle;
}
