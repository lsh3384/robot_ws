...
msg_srv_interface_py_test__msg__Coordinates__init(msg_srv_interface_py_test__msg__Coordinates * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    msg_srv_interface_py_test__msg__Coordinates__fini(msg);
    return false;
  }
  // coordinate_x
  // coordinate_y
...
{
  msg_srv_interface_py_test__msg__Coordinates * msg = (msg_srv_interface_py_test__msg__Coordinates *)malloc(sizeof(msg_srv_interface_py_test__msg__Coordinates));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg_srv_interface_py_test__msg__Coordinates));
  bool success = msg_srv_interface_py_test__msg__Coordinates__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
msg_srv_interface_py_test__msg__Coordinates__Sequence__init(msg_srv_interface_py_test__msg__Coordinates__Sequence * array, size_t size)
{
  ...
  msg_srv_interface_py_test__msg__Coordinates * data = NULL;
  if (size) {
    data = (msg_srv_interface_py_test__msg__Coordinates *)calloc(size, sizeof(msg_srv_interface_py_test__msg__Coordinates));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg_srv_interface_py_test__msg__Coordinates__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msg_srv_interface_py_test__msg__Coordinates__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
msg_srv_interface_py_test__msg__Coordinates__Sequence__fini(msg_srv_interface_py_test__msg__Coordinates__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msg_srv_interface_py_test__msg__Coordinates__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  msg_srv_interface_py_test__msg__Coordinates__Sequence * array = (msg_srv_interface_py_test__msg__Coordinates__Sequence *)malloc(sizeof(msg_srv_interface_py_test__msg__Coordinates__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = msg_srv_interface_py_test__msg__Coordinates__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    msg_srv_interface_py_test__msg__Coordinates__Sequence__fini(array);
  }
  free(array);
}
