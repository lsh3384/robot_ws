...
static size_t _ArithmeticChecker_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_Goal(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: all_formula
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->all_formula, size)) {
      return "failed to create array for field 'all_formula'";
    }
    auto array_ptr = ros_message->all_formula.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _ArithmeticChecker_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_Result(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: formula
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->formula, size)) {
      return "failed to create array for field 'formula'";
    }
    auto array_ptr = ros_message->formula.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _ArithmeticChecker_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_Feedback(
    full_bounded, 0);
}
...
static size_t _ArithmeticChecker_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _ArithmeticChecker_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _ArithmeticChecker_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _ArithmeticChecker_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _ArithmeticChecker_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_msg_srv_action_interface_example__action__ArithmeticChecker_FeedbackMessage(
    full_bounded, 0);
}
