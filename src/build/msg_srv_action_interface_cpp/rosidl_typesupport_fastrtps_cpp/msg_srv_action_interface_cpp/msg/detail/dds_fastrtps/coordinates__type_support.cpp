...
#include "msg_srv_action_interface_cpp/msg/detail/coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_srv_action_interface_cpp::msg::Coordinates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_srv_action_interface_cpp::msg::Coordinates & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const msg_srv_action_interface_cpp::msg::Coordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_srv_action_interface_cpp::msg::Coordinates *>(
    untyped_ros_message);
...
{
  return &msg_srv_action_interface_cpp::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_srv_action_interface_cpp, msg, Coordinates)() {
  return &msg_srv_action_interface_cpp::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
